...
//                getXmlData("39", "24");
        ...
        Log.d("확인", "CentralFragment_" + arrayList.size());
        Log.d("확인", "CentralFragment_onAttach()");
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Log.d("확인", "CentralFragment_" + arrayList.size());
        Log.d("확인", "CentralFragment_onCreateView()");
        return view;
    }
    ...
    public void onResume() {
        ...
        Log.d("확인", "CentralFragment_" + arrayList.size());
        Log.d("확인", "CentralFragment_onResume()");
    }
    ...
    private void getXmlData(String contenttypeid, String sigungucode) {
        ...
        String queryURL =
                ...
                + MainActivity.KEY
                + "&numOfRows=1280&MobileApp=" + MainActivity.APP_NAME + "&MobileOS=ETC&arrange=B&contentTypeId=" + contenttypeid + "&areaCode=1&sigunguCode=" + sigungucode;
