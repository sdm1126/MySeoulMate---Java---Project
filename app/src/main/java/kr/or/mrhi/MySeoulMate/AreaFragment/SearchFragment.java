...
//                getXmlData("39", "21");
        ...
        Log.d("확인", keyword);
        Log.d("확인", "SearchFragment_" + arrayList.size());
        Log.d("확인", "SearchFragment_onAttach()");
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Log.d("확인", "SearchFragment_" + arrayList.size());
        Log.d("확인", "SearchFragment_onCreateView()");
        return view;
    }
    ...
    // 기본 정보
    private void getXmlData(String contenttypeid, String keyword) {
        Attraction attraction = null;
        String tag = null;

        String queryURL =
                "http://api.visitkorea.or.kr/openapi/service/rest/KorService/searchKeyword?serviceKey="
                + MainActivity.KEY
                + "&MobileApp=" + MainActivity.APP_NAME + "&MobileOS=ETC&numOfRows=2000&arrange=B&contentTypeId=" + contenttypeid + "&areaCode=1&keyword=" + keyword;
