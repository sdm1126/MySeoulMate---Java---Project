...
public class SouthEastFragment extends Fragment {
    ...
    public static SouthEastFragment newInstance() {
...
//                getXmlData("39", "18");
    ...
    private void getXmlData(String contenttypeid, String sigungucode) {
        ...
        String queryURL =
                ...
                + MainActivity.KEY
                + "&numOfRows=550&MobileApp=" + MainActivity.APP_NAME + "&MobileOS=ETC&arrange=B&contentTypeId=" + contenttypeid + "&areaCode=1&sigunguCode=" + sigungucode;
